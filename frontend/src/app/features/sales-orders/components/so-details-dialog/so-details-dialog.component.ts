...
@Component({
  selector: 'app-so-details-dialog',
  templateUrl: './so-details-dialog.component.html',
  styles: [`
...
export class SoDetailsDialogComponent {
  constructor(
    public dialogRef: MatDialogRef<SoDetailsDialogComponent>,
    @Inject(MAT_DIALOG_DATA) public so: SalesOrder
  ) {}
